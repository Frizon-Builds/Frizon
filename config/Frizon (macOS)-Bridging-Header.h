...
// • Ensure that `#import MyObjcClass.h` is present in `Frizon (macOS)-Bridging-Header.h`.
// 5. To use your Swift code from Objective-C:
// • Add `@class MySwiftClass` to your .h files that depend on the Swift code;
// • No need to import the Swift Bridging Header (`Frizon_(macOS)-Swift.h`), since it's already being imported from the .pch file.
